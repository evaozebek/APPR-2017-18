...
Spodnji graf prikazuje število razvez z otroci in brez. Rdeča - z otroki, oranžna - brez otrok *dodaj legendo!!!*
...
Graf prikazuje trajanje zakonskih zvez pred ločitvijo. Trajanje zakonske zveze pod 1 letom prikazuje modra, trajanje zakonske zveze 1-4 leta prikazuje zelena, trajanje zakonske zveze 5-9 let rdeča, trajanje zakonske zveze 10-14 let oranžna in rajanje zakonske zveze 15 let ali več rumena.

```{r trajanje200, echo=FALSE, message=FALSE, fig.align='center'}
print(trajanje200)
```
...
Predvidevam, da se bo število sklenitev zakonskih zvez v prihodnosti še malo zmanjšalo, a nato postalo konstantno.
